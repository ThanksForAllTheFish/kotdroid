...
data class GameData(val code: String,
                    val subtype: Sequence<String>,
                    val faction: Faction,
                    val side: String,
                    val text: String,
                    val uniqueness: Boolean)

data class Metadata(val lastModified: LocalDateTime, val title: String, val number: Int, val quantity: Int, val set: String,
...
data class Agenda(val base: BaseCard, val advacementTokens: Int, val agendaPoits: Int, val limited: Int): Card
